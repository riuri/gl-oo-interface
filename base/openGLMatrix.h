...
/*
  ...
  Update: it was modified by Rodrigo Castiel: method GetGLMatrix() added.
*/
...
public:
  ...
  /* Added by Rodrigo Castiel */
  glm::mat4& GetGLMatrix() { return currentMatrix[(int)matrixMode]; }
  void Invert();  // Inverts the top matrix.
